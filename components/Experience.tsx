            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center justify-between mb-1">
                    <h3 className="font-bold text-gray-900 dark:text-gray-100 truncate pr-4 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                        {job.company}
                    </h3>
                    <span className="text-xs font-mono text-gray-500 dark:text-gray-400 whitespace-nowrap bg-gray-100 dark:bg-gray-800 px-2 py-0.5 rounded">
                        {job.period}
                    </span>
                </div>
