...
import { Heart, Eye, Layout, Box, Cpu } from 'lucide-react';
...
const ProjectCard = ({ project, index }: { project: any; index: number }) => {
  ...
  return (
    <div className="group bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl p-4 hover:border-gray-300 dark:hover:border-gray-600 transition-all duration-200 hover:shadow-md flex flex-col h-full">
      <div className="flex items-start justify-between mb-3">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-700 border border-gray-200 dark:border-gray-700 flex items-center justify-center text-xl shadow-sm">
            {index === 0 ? '🧠' : index === 1 ? '📦' : '👕'}
          </div>
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{project.category} • Updated recently</p>
          </div>
        </div>
      </div>
      ...
      {project.image && (
        <div className="w-full h-32 mb-4 rounded-lg overflow-hidden border border-gray-100 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 relative">
